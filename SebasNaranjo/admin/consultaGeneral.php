...
<?php
    ...
    <div>
        <table class="table table-striped text-bg-light">
            <tr>
            ...
            $sql="SELECT id, userName, userMail, userDocument, registerDate, modificationDate FROM registeruser order by id desc";
