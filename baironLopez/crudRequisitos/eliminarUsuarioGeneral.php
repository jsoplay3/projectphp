...
<script src="validacionElim.js"></script>
<body>
<div class="container"><?php
        include("menu.php");
    ?>
    <h2>Eliminar Usuario</h2>
    <form action="eliminarUsuarioEspecifico.php" method="post" onsubmit="return validacionUsuElim()">
        <label for="" class="form-label">Numero de documento del usuario a eliminar</label>
        <input type="text" name="usuarioEliminar" id="usuarioEliminar" class="form-control">
